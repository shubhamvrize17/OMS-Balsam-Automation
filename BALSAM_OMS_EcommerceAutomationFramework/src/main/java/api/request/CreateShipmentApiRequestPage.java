...
public class CreateShipmentApiRequestPage {
	...
	public static String readOrderPayload() throws IOException {
		return generateStringFromResource(
				"C:\\Shubham\\OMS-Balsam-Automation\\BALSAM_OMS_EcommerceAutomationFramework\\src\\test\\resources\\testData\\payload\\create shipment.xml");
	}
